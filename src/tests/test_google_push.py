...
class TestGoogleCalendarReminders:
    """Verify _calendar_event_to_google_body builds reminder overrides correctly."""
    ...
    def test_midnight_reminder_override(self):
        from src.integrations.google_push import _calendar_event_to_google_body
        from src.services.calendar_events import CalendarEvent
        from datetime import date
    ...
    def test_no_reminders_disables_default(self):
        from src.integrations.google_push import _calendar_event_to_google_body
        from src.services.calendar_events import CalendarEvent
        from datetime import date
    ...
    def test_timed_event_with_reminder(self):
        from src.integrations.google_push import _calendar_event_to_google_body
        from src.services.calendar_events import CalendarEvent
